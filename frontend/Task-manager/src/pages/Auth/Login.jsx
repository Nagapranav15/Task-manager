  ...
  return (
    <AuthLayout>
      <div className="w-full flex flex-col justify-center">
        <h3 className="text-xl font-black text-slate-100 tracking-tight">Welcome back</h3>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <p className="text-xs text-slate-400 mt-4 text-center">
            ...
            <Link className="font-bold text-indigo-400 hover:text-indigo-300 transition-colors" to="/signup">
              Sign Up
            </Link>
          </p>
        </form>
