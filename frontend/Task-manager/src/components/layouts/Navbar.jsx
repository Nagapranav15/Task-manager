...
const Navbar = ({ activeMenu }) => {
    ...
    return (
        <div className="flex items-center justify-between bg-white dark:bg-slate-950/50 backdrop-blur-lg border-b border-slate-200 dark:border-slate-900/85 py-3 px-8 sticky top-0 z-30 text-slate-800 dark:text-slate-100 shadow-md">
            <div className="flex items-center gap-5">
                <button className="block lg:hidden text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-white transition-colors cursor-pointer"
                    onClick={() => {
                ...
                <h2 className="text-sm font-black uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-violet-500 dark:from-indigo-400 dark:to-violet-400">
                    Task Manager
                </h2>
            </div>
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className="p-2 rounded-xl bg-slate-100 dark:bg-slate-900/60 hover:bg-slate-200 dark:hover:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all cursor-pointer"
